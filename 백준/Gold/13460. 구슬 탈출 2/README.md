...
### BFS를 Queue로 구현하는 이유 
 <p>
  가지를 뻗어 나갈 때 낮은 차수에 더 높은 우선순위를 부여하기 위함. </p>
 <p>
  BFS에서 continue를 "CASE 버리기" 정도로 생각하면 된다.
 </p>
 <p>
  일반적인 BFS 구현 로직 :  Queue를 이용해서 Queue에 아무것도 남지 않을 때 까지 조건을 수행한다. 
 </p>
